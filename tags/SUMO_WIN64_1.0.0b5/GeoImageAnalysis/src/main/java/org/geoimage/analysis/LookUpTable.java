...
public class LookUpTable {
    ...
    // the look-up table to get the clipping thresh (0) or the detection thresh
    // (1) from the evaluated clipped standard deviation
    ...
    // the look-up table to get the clipping thresh from the evaluated unclip
    // standard deviation
