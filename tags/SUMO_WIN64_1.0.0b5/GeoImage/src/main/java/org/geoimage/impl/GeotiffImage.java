...
**/
    ...
    private void createGcpsFromCornerPoints() {
        ...
        double[] x2;
        double[] x3;
        x0 = geotransform.getGeoFromPixel(0, 0, "EPSG:4326");
        x2 = geotransform.getGeoFromPixel(getWidth(), getHeight(), "EPSG:4326");
        x3 = geotransform.getGeoFromPixel(getWidth(), 0, "EPSG:4326");
        x1 = geotransform.getGeoFromPixel(0, getHeight(), "EPSG:4326");
        gcps = new Vector<Gcp>();
