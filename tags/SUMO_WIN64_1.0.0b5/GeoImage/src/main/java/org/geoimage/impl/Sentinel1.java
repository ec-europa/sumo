...
public abstract class Sentinel1 extends SarImageReader {
    ...
    public boolean initialise(File manifestXML) {
        try {
			...
			File mainFolder=manifestXML.getParentFile();
			String annotationFilePath=mainFolder.getAbsolutePath()+"/annotation/"+nameFirstFile;
    ...
    */
    ...
    public String getName() {
        return tiffImages.get(getBandName(band)).getImageFile().getName();//getFilesList()[0];
    }
