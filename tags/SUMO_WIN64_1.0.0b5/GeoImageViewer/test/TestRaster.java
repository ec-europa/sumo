...
public class TestRaster {
	...
	public static void readSLCRasterBand(int x, int y, int width, int height) throws IOException {
		...
		sampleModel.getSamples(0, 0, width, height, 0, srcArray,data.getDataBuffer());
	...
	public static void main(String[] args){
		try {
			TestRaster.readSLCRasterBand(0,0,16,16);
		} catch (IOException e) {
