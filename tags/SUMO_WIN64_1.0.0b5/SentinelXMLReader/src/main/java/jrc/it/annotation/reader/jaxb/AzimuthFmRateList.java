 ...
 *       &lt;sequence>
 *         &lt;element ref="{}azimuthFmRate" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "azimuthFmRateList")
public class AzimuthFmRateList {

    @XmlElement(required = true)
    protected List<AzimuthFmRate> azimuthFmRate;
     ...
     * 
     */
    public List<AzimuthFmRate> getAzimuthFmRate() {
        if (azimuthFmRate == null) {
            azimuthFmRate = new ArrayList<AzimuthFmRate>();
        }
