...
public class ObjectFactory {
    ...
    private final static QName _RunVersionOri_QNAME = new QName("", "run_version_ori");
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "run_version_ori")
    public JAXBElement<String> createRunVersionOri(String value) {
        return new JAXBElement<String>(_RunVersionOri_QNAME, String.class, null, value);
    }
