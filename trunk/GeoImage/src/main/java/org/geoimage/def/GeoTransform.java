...
public interface GeoTransform {
     ...
     */
    public double[] getPixelFromGeo(double[] src, int srcOffset, double[] dest, int destOffset,int numPoints, String inputWktProjection)throws NoSuchAuthorityCodeException, FactoryException ;
    /**
     ...
     */
    public double[] getGeoFromPixel(double[] src, int srcOffset, double[] dest, int destOffset,int numPoints, String outputWktProjection)throws NoSuchAuthorityCodeException, FactoryException;
