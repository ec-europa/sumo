 ...
 *       &lt;sequence>
 *         &lt;element ref="{}geolocationGridPoint" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "geolocationGridPointList")
public class GeolocationGridPointList {

    @XmlElement(required = true)
    protected List<GeolocationGridPoint> geolocationGridPoint;
     ...
     * {@link GeolocationGridPoint }
     * 
     * 
     */
    public List<GeolocationGridPoint> getGeolocationGridPoint() {
        if (geolocationGridPoint == null) {
            geolocationGridPoint = new ArrayList<GeolocationGridPoint>();
        }
